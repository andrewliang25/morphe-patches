...
|---|---|---|
| Outbound photo compression | **client** — `u13.c1` resamples + JPEG-encodes locally before upload; the server never sees the original | **patchable** (`originalphoto`) |
